...
public class Data {
	...
	public static ArrayList<MatHang> danhsachhanghoa() {
		...
		danhsachhang.add(new MatHang("Thực phẩm", "VN10", "Bánh Quy Kem", 12000, 42, "12/02/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN11", "Chén sứ Minh Long", 20000, 200, "15/10/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN12", "Dĩa sứ Minh Long", 15000, 200, "15/10/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN13", "Muỗng Sứ Minh Long", 25000, 200, "15/02/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN14", "Ly sứ Nhật bản", 100000, 200, "14/04/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN15", "Bát gốm Bát Tràng", 140000, 300, "15/05/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN16", "Chậu hoa sứ", 150000, 1000, "16/06/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN17", "Lọ hoa sứ", 170000, 200, "17/01/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN18", "Chuông gió nhập khẩu", 20000, 1000, "20/04/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN19", "Bộ ấm trà", 25000, 1000, "15/02/2021"));
		danhsachhang.add(new MatHang("Sành sứ", "VN20", "Đũa sứ 1 đôi", 25000, 400, "20/01/2022"));
		danhsachhang.add(new MatHang("Điện máy", "VN21", "Tủ lạnh Samsung Inverter", 5000000, 200, "14/07/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN22", "Samsung Smart TV QLED", 6000000, 200, "22/05/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN23", "Máy Lọc Nước Aqua ", 800000, 500, "02/12/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN24", "Quạt đứng Senko", 150000, 500, "24/03/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN25", "Daikin Inverter 1.5 HP", 5600000, 500, "22/10/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN26", "Bếp Điện SunHouse", 1200000, 400, "26/11/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN27", "Nồi cơm điện tử SunHouse 1,8L", 3200000, 300, "20/05/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN28", "Quạt mini Asian", 500000, 300, "22/10/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN29", "Bàn ủi hơi nước Philips", 3200000, 300, "26/08/2021"));
		danhsachhang.add(new MatHang("Điện máy", "VN30", "Máy xay đa năng Kangaroo", 800000, 500, "26/01/2021"));
		return danhsachhang;
	}
